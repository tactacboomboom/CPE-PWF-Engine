```
# 𝕊ₙ — Sprint (Task Plan)
**Rôle CPE :** Instance opérationnelle du contrat via μₙ. [16, 17]
**Lien :** Projection stricte de 𝕮ₙ (Bijection Backlog = Phases). [18, 19]
**Contrainte :** Modifie le "Comment" (Strike 3) mais jamais le "Quoi". [20, 21]
```
