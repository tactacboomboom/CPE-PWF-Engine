```
# 𝕮ₙ — Contrat de Sprint
**Rôle CPE :** Commande testable (Goal, Backlog, DoD). [10, 11]
**Validation :** Doit obtenir PASS via le validateur 𝕍. [12, 13]
**Priorité :** Définit le "Quoi" ; ne peut être modifié que par κₙ. [14, 15]
```
